...
<html lang="en">
  <head>
    ...
    <link rel = "icon" href ="img/logoIT.jpg" type = "image/x-icon">
    <!-- Google Fonts -->
      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <nologyh2 class="animate__animated animate__fadeInDown mb-0">Bs Information Tech</nologyh2><p>BSIT<a href="https://github.com/nonito02" target="_blank">@Norts</a></p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3>Welcome to <strong>Code Bar</strong></h3>
            <h3><strong>Bite for Smooth Debuging session</strong></h3>
            <p class="font-italic">
          </div>
